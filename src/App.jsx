...
function App() {
  ...
  return (
    <div className="bg-black text-white font-sans">
      ...
      {/* Hero Section */}
      <section id="home" className="bg-cover bg-[center_top_30%] text-center min-h-[60vh] flex items-center justify-center px-4" style={{ backgroundImage: `url(${backgroundImage})` }}>
